...
## Installation
We recommend installing from GitHub or CRAN (https://cran.r-project.org/web/packages/twosigma/) for the latest version (1.0.2) of the package, which is built for any version of R >= 3.6.3 (including R >= 4.0):
```r
