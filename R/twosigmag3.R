...
twosigmag3<-function(count_matrix,index_test,index_ref=NULL,all_as_ref=FALSE,mean_form,zi_form,mean_form_null=NULL,zi_form_null=NULL
  ...
  #a<-bplapply(X=count_matrix[genes,],FUN=fit_tsg,statistic=statistic,
